...
//        panelInformation.setBorder(new LineBorder(new Color(0, 0, 0), 1, true));
    ...
    private void createGraphPanel() {
        ...
        panelGraphContainer = new Rounded_Panel(25, Color.BLACK, 0);
    ...
    private void createGraphShadowPanels() {
        panelBehind1 = new Rounded_Panel(25, Color.BLACK, 0);
        panelBehind1.setBackground(new Color(220, 220, 220));
//        panelBehind1.setBorder(new LineBorder(new Color(0, 0, 0), 1, true));
        panelBehind1.setBounds(520, 142, 413, 365);
        add(panelBehind1);
        
        panelBehind2 = new Rounded_Panel(25, Color.BLACK, 0);
        panelBehind2.setBackground(new Color(200, 200, 200));
//        panelBehind2.setBorder(new LineBorder(new Color(0, 0, 0), 1, true));
        panelBehind2.setBounds(536, 129, 413, 356);
        add(panelBehind2);
        
        panelBehind3 = new Rounded_Panel(25, Color.BLACK, 0);
        panelBehind3.setBackground(new Color(180, 180, 180));
