...
public class GraphTest {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            electricityGraph.setMonthlyData("Electricity", testData.get("electricity"));
            ...
            waterGraph.setMonthlyData("Water", testData.get("water"));
            ...
            gasGraph.setMonthlyData("Gas", testData.get("gas"));
            ...
            overallGraph.setMonthlyData("Total", testData.get("overall"));
